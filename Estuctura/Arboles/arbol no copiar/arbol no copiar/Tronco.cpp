...
void arbol::RotacionDoble(hoja* nodo, bool izquierda)
{
    ...
    /* la actualización de las alts se realiza en las rotaciones
    simples */
}
...
int main()
{
    ...
    do
    {
        ...
        case 2:
            ...
            cin >> x;
            dat.eliminar(dat.root, x, existe);
            break;
            }
        ...
        case 7:
            ...
            cin >> x;
            existe = 0;
            existe = dat.buscar(dat.root, x, existe);
            if (existe == 1)
        ...
        case 8:
            ...
            contar = dat.contar(dato, dat.root, 0);
